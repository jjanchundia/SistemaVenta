...
const ReporteVenta = () => {
    ...
    const buscar = () => {
        ...
        const api = fetch(`http://localhost:5158/api/venta/Reporte?fechaInicio=${_fechaInicio}&fechaFin=${_fechaFin}`)
            .then((response) => {
    ...
    return (
        <>
            ...
            <Row>
                <Col sm={12}>
                    <Card>
                        <CardHeader style={{ backgroundColor: '#4e73df', color: 'white' }}>Reporte de ventas</CardHeader>
                        <CardBody>
                            ...
                            <Row>
                                <Col sm="12">
                                    <DataTable progressPending={pendiente} columns={columns} data={ventas} customStyles={customStyles} />
                                </Col>
                            </Row>
                        </CardBody>
                    </Card>
